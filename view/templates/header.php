		...
		<div class="btn dropdown show">
			<a class="dropdown-toggle text-primary" style="font-size: 2.5em;" href="#" role="button" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" href="<?= URL ?>student/index">Manege</a>
				<div class="dropdown-menu text-center" aria-labelledby="dropdownMenuLink">
					...
					<h3 class="dropdown-item text-primary"><a href="<?= URL ?>student/registeruser">Relatie beheer</a></h3>
					<h3 class="dropdown-item text-primary"><a href="<?= URL ?>student/OverviewStudents">Overzicht Studenten</a></h3>
					<h3 class="dropdown-item text-primary"><a href="<?= URL ?>student/Overview">Overzicht Reservaties</a></h3>
					<h3 class="dropdown-item text-primary"><a href="<?= URL ?>student/reserve">Reserveren</a></h3>
					<h3 class="dropdown-item text-primary"><a href="<?= URL ?>student/HorsePage">Beheer van </br> paarden en pony's</a></h3>
